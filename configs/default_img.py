...
_C.DATA.ROOT = '/mnt/sda/hxy_bak/dataset/'
...
# ---------------- NEW ----------------
# Range of keep ratio for ERASE (下界, 上界)
_C.LOSS.ERASE_KEEP_RANGE = [0.3, 0.4]
# Dilation pixels for mask (腐蚀膨胀次数)
_C.LOSS.ERASE_DILATE_PX = 1

# Weight for adversarial loss
_C.LOSS.ADV_WEIGHT = 1.0
# Weight for attention loss
_C.LOSS.ATT_WEIGHT = 1.0

# Random erase prob
_C.LOSS.ERASE_PROB = 0.3
...
_C.OUTPUT = '/mnt/sda/third/result/ltcc_baseline2'
